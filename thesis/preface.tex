...
(TODO: why is the Roman tradition everywhere now?) % something with Charles the Great? - unification
...
% change this to a nenw chapter
% originially chants were notated as neumes that served as memory aids - in 12 century they encoded specific pitches
% mention the most important terms
% at the end of the chapter - chant reseearch: active area of musicology covering many centuries and the whole continent; it has a rich digital infrastructure

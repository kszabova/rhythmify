...
% the application does not substitute the function for database webs
% it is functionality for user-uploaded data
% we uploaded some data, but to do research, the researchers must upload their own data!
...
% explain the basic objects - data source - what it is
...
% create data source from user-defined search
% say what incipit* means
...
% refer to the first image when talking about the buttons
...
\section{Dashboard}
% some basic state, waiting for other features
% it is not clear what will be needed - well see from how its used

\section{Known issues}
% different width of volpiano
% when aligning more than x chants, loading is slow